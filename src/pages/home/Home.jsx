...
import { getFaucetsBalances } from "../../api"
...
const Home = () => {
    ...
    const claimTokens = () => {
        ...
        if (address.match(regex)) {
            fetch("http://localhost:3333/v1/api/request", {
                method: "POST",
                headers: {
                    "X-RapidAPI-Key":
    ...
    return (
        <Container chainId={chainId} isActive={isActive}>
            ...
            <div className="home-top">
                ...
                <NavLink to="/transactions" className="home-link">
            ...
            <div className="content-wrapper-networks">
                ...
                <div className="select-networks">
                    ...
                    <ul className="sepolia">
                        ...
                        <li>{sepoliaFaucetDripAmount} FEL</li>
                        <li>{balanceSepolia.slice(0, -18)} FEL</li>
                    </ul>
                    <ul className="mumbai">
                        <li>
                        ...
                        <li>{mumbaiFaucetDripAmount} FEL</li>
                        <li>{balanceMumbai.slice(0, -18)} FEL</li>
                    </ul>
                </div>
            </div>
            ...
            <div className="content-wrapper-request">
                ...
                <div className="request-tokens">
                    ...
                    <button
                        ...
                        disabled={
                            !isWeb3Enabled ||
                            (sepoliaFaucetDripAmount === "0" &&
                                mumbaiFaucetDripAmount === "0")
                        }
